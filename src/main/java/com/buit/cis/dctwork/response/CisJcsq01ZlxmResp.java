 ...
 */
public class CisJcsq01ZlxmResp {
    ...
    @ApiModelProperty(value="手术所见(病例检查申请时用）")
    private String sssj;
    @ApiModelProperty(value="检查日期（曾在何处做过病理检查）")
    private Date jcrq;
    @ApiModelProperty(value="病理号（曾在何处做过病理检查）")
    private String jcblh;
    @ApiModelProperty(value="检查医院（曾在何处做过病理检查）")
    private String jcyy;
    @ApiModelProperty(value="诊断（曾在何处做过病理检查）")
    private String jczd;
    @ApiModelProperty(value="末次月经日期")
    private Date mcyjrq;
    @ApiModelProperty(value="经量")
    private String jl;
    @ApiModelProperty(value="周期及持续时间")
    private String zqjcxsj;
    @ApiModelProperty(value="有否质量（内分泌） 1是2否")
    private String yfzl;
    @ApiModelProperty(value="有否质量对应的日期")
    private Date yfzlrq;
    @ApiModelProperty(value="剂量及持续时间")
    private String jljcxsj;
    @ApiModelProperty(value="刮宫日期")
    private Date ggrq;
    ...
    private Timestamp sdrq;
    @ApiModelProperty(value="签收人")
    private String qsr;
    
    @ApiModelProperty(value="诊疗项目树结构")
    private List<DicYjlxZlxmApiResp> children;
    
    @ApiModelProperty(value="诊疗项目集合")
    private List<CisJcsq02ZlxmResp> cisJcsq02ZlxmRespList;
    
    @ApiModelProperty(value="理疗项目内容集合")
    private List<CisJcsq03Resp> cisJcsq03RespList;
	...
	public String getJcblh() {
		return jcblh;
	}
	
	public void setJcblh(String jcblh) {
		this.jcblh = jcblh;
	}
	...
	public String getZqjcxsj() {
		return zqjcxsj;
	}
	
	public void setZqjcxsj(String zqjcxsj) {
		this.zqjcxsj = zqjcxsj;
	}
	...
	public Date getYfzlrq() {
		return yfzlrq;
	}
	
	public void setYfzlrq(Date yfzlrq) {
		this.yfzlrq = yfzlrq;
	}
	
	public String getJljcxsj() {
		return jljcxsj;
	}
	
	public void setJljcxsj(String jljcxsj) {
		this.jljcxsj = jljcxsj;
	}
	...
	public Timestamp getSdrq() {
		return sdrq;
	}
	
	public void setSdrq(Timestamp sdrq) {
		this.sdrq = sdrq;
	}
	...
	public List<DicYjlxZlxmApiResp> getChildren() {
		return children;
	}
	
	public void setChildren(List<DicYjlxZlxmApiResp> children) {
		this.children = children;
	}
	
	public List<CisJcsq02ZlxmResp> getCisJcsq02ZlxmRespList() {
		return cisJcsq02ZlxmRespList;
	}
	
	public void setCisJcsq02ZlxmRespList(List<CisJcsq02ZlxmResp> cisJcsq02ZlxmRespList) {
		this.cisJcsq02ZlxmRespList = cisJcsq02ZlxmRespList;
	}
	
	public List<CisJcsq03Resp> getCisJcsq03RespList() {
		return cisJcsq03RespList;
	}
	
	public void setCisJcsq03RespList(List<CisJcsq03Resp> cisJcsq03RespList) {
		this.cisJcsq03RespList = cisJcsq03RespList;
	}
