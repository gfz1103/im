...
/**
 * 类名称：CisZyHzsqAndYjResp<br> 
 * 类描述：<br>
 * @author GONGFANGZHOU
 */
@ApiModel(value="医生住院会诊申请和意见_Resp")
public class CisZyHzsqAndYjResp  {
	...
	@ApiModelProperty(value="会诊意见集合")
	private List<CisZyHzyjResp> cisZyHzyjRespList;
    /** 设置:申请序号  */
	...
	public List<CisZyHzyjResp> getCisZyHzyjRespList() {
		return cisZyHzyjRespList;
	}
	
	public void setCisZyHzyjRespList(List<CisZyHzyjResp> cisZyHzyjRespList) {
		this.cisZyHzyjRespList = cisZyHzyjRespList;
	}
