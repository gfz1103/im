 ...
 * @author GONGFANGZHOU
 */
@ApiModel(value="医生住院会诊申请_Resp")
public class CisZyHzsqResp  extends  PageQuery{
    @ApiModelProperty(value="申请序号")
    private Integer sqxh;
    @ApiModelProperty(value="住院号")
    private String jzhm;
    @ApiModelProperty(value="申请科室(字典:sys_dict_config:15)")
    private Integer sqks;
    @ApiModelProperty(value="申请医生(字典:sys_dict_config:17)")
    private String sqys;
    ...
    private Date hzsj;
    @ApiModelProperty(value="会诊邀请对象(字典:sys_dict_config:16)")
    private String yqdx;
    @ApiModelProperty(value="紧急标志(字典:sys_flag_data:JJ000001)")
    private Integer jjbz;
    @ApiModelProperty(value="提交标志(字典:sys_flag_data:TJ000001)")
    private Integer tjbz;
    @ApiModelProperty(value="提交医生")
    private String tjys;
    @ApiModelProperty(value="提交时间")
    private Timestamp tjsj;
    @ApiModelProperty(value="作废标志(字典:sys_flag_data:ZF000001)")
    private Integer zfbz;
    @ApiModelProperty(value="结束标志(字典:sys_flag_data:JS000001)")
    ...
    private String bqzl;
    @ApiModelProperty(value="拟邀请会诊医院  1:本院，2:外院(字典:sys_flag_data:HZ000001)")
    private String nhzyy;
    @ApiModelProperty(value="拟邀请会诊医院名称")
    private String nyqhzyy;
    @ApiModelProperty(value="拟邀会诊科室（本院）(字典:sys_dict_config:15)")
    ...
    @ApiModelProperty(value="主治以上医师/科主任医师签名(字典:sys_dict_config:17)")
    private String kzrys;
    
    @ApiModelProperty(value="拟邀会诊医生")
    private String nyqhzys3;
    
    @ApiModelProperty(value="拟邀会诊科室")
    private String nyqhzks3;
    ...
    @ApiModelProperty(value="是否能填写会诊意见")
     ...
     * 设置:会诊时间
     */
    public void setHzsj(Date value) {
        this.hzsj = value;
    }
    /**
     * 获取:会诊时间
	...
	public String getNyqhzys3() {
		return nyqhzys3;
	}
	
	public void setNyqhzys3(String nyqhzys3) {
		this.nyqhzys3 = nyqhzys3;
	}
	
	public String getNyqhzks3() {
		return nyqhzks3;
	}
	
	public void setNyqhzks3(String nyqhzks3) {
		this.nyqhzks3 = nyqhzks3;
	}
