...
public class CisHzyzReq  extends  PageQuery{
    ...
    @ApiModelProperty(value="抗菌药物审批结果")
    private Integer kjywsp;
    
    @ApiModelProperty(value="数据库操作方式")
    private String	opStatus;
    
    @ApiModelProperty(value="停止医生姓名")
    private String	tzysText;
    
    @ApiModelProperty(value="显示医嘱组号")
    private Integer yzzhShow;
    
    @ApiModelProperty(value="独有Id")
    private String uniqueId;
    
    @ApiModelProperty(value="停嘱标识")
    private String needRemaid;
     ...
     * 设置:停止时间
     */
    public void setTzsj(String value) {
        this.tzsj = value;
    }
    /**
     * 获取:停止时间
	...
	public String getTzysText() {
		return tzysText;
	}
	
	public void setTzysText(String tzysText) {
		this.tzysText = tzysText;
	}
	
	public Integer getYzzhShow() {
		return yzzhShow;
	}
	
	public void setYzzhShow(Integer yzzhShow) {
		this.yzzhShow = yzzhShow;
	}
	
	
	public String getNeedRemaid() {
		return needRemaid;
	}
	
	public void setNeedRemaid(String needRemaid) {
		this.needRemaid = needRemaid;
	}
