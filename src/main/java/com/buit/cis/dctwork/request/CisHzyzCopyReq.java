 ...
 * @author GONGFANGZHOU
 */
@ApiModel(value="住院_病区医嘱_CopyReq")
public class CisHzyzCopyReq {
	...
	@ApiModelProperty(value="医嘱类型(0:长期1:临时2:急诊用药3:出院带药)")
	private Integer yzlx;
	
	@ApiModelProperty(value="复制集合")
	private List<CopyBody> copyBodyList;
	...
	public List<CopyBody> getCopyBodyList() {
		return copyBodyList;
	}

	public void setCopyBodyList(List<CopyBody> copyBodyList) {
		this.copyBodyList = copyBodyList;
	}

	public static class CopyBody {
