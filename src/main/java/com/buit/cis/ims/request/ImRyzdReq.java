...
public class ImRyzdReq {
    ...
    @ApiModelProperty(value="诊断序号(新)")
    private Integer zdxhnew;
    
    @ApiModelProperty(value="诊断类别 (新)")
    private Integer zdlbnew;
	...
	public Integer getZdxhnew() {
		return zdxhnew;
	}
	
	public void setZdxhnew(Integer zdxhnew) {
		this.zdxhnew = zdxhnew;
	}
	
	public Integer getZdlbnew() {
		return zdlbnew;
	}
	
	public void setZdlbnew(Integer zdlbnew) {
		this.zdlbnew = zdlbnew;
	}   
