 ...
 * @author GONGFANGZHOU
 */
@ApiModel(value="压力性损伤预报、传报单_Req")
public class NisYlxsscbdReq  extends  PageQuery{
    /**
	...
	*/
    ...
    List<NisYlxssjksfReq> nisYlxssjksfList;
    @ApiModelProperty(value="转归情况集合")
    List<NisYlxsszgReq> nisYlxsszgList ;
    /**
     * 设置:主键
     */
	...
	public List<NisYlxssjksfReq> getNisYlxssjksfList() {
		return nisYlxssjksfList;
	}
	public void setNisYlxssjksfList(List<NisYlxssjksfReq> nisYlxssjksfList) {
		this.nisYlxssjksfList = nisYlxssjksfList;
	}
	public List<NisYlxsszgReq> getNisYlxsszgList() {
		return nisYlxsszgList;
	}
	public void setNisYlxsszgList(List<NisYlxsszgReq> nisYlxsszgList) {
