...
public interface NisDdzcpgbDao extends EntityDao<NisDdzcpgb,Integer>{
     ...
     * @throws
     */
    List<NisDdzcpgbResp> queryDdzcpgbByDate(@Param("zyh") Integer zyh, @Param("queryDate") String queryDate, 
     ...
     * @throws
     */
    List<Map<String, Object>> queryPrintDdzcpgbByDate(@Param("zyh") Integer zyh, @Param("queryDate") String queryDate, 
    		@Param("jgid") Integer jgid);
}
