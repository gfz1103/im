...
public interface NisChhldDao extends EntityDao<NisChhld,Integer>{
     ...
     * @throws
     */
    List<NisChhld> queryChhldByDate(NisHlQueryReq nisHlQueryReq);
    
    /**
     * 产后护理记录单查询树结构
     * @Title: queryChhldTreeDetail
     * @Description: TODO(这里用一句话描述这个方法的作用)
     * @param @param zyh
     * @param @param jgid
     * @param @return    设定文件
     ...
     * @throws
     */
    List<NisHzmbDetailResp> queryChhldTreeDetail(@Param("zyh") Integer zyh, @Param("jgid") Integer jgid,
