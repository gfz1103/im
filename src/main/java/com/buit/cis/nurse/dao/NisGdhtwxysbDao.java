...
public interface NisGdhtwxysbDao extends EntityDao<NisGdhtwxysb,Integer>{
     ...
     * @throws
     */
    List<NisGdhtwxysbResp> queryGdhtwByDate(NisHlQueryReq nisHlQueryReq);
     ...
     * @throws
     */
    List<Map<String, Object>> queryPrintGdhtwByDate(NisHlQueryReq nisHlQueryReq);
     ...
     * @throws
     */
    List<NisHzmbDetailResp> queryGdhtTreeDetail(@Param("zyh") Integer zyh, @Param("jgid") Integer jgid,
